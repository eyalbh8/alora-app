  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <h1 className="font-serif text-2xl font-semibold tracking-tight text-[#101414]">Analytics</h1>
        <div className="flex items-center gap-2">
          {settings?.prompts_count != null && (
            <span className="rounded-lg border border-slate-200/80 bg-white px-3 py-1.5 text-xs font-medium text-slate-600 shadow-sm">
