    ...
    <div className="flex flex-wrap items-center justify-between gap-3 border-t border-line py-2.5 pl-1 font-mono text-[12px] tracking-[0.1em] text-muted uppercase sm:justify-end sm:gap-5">
      <div ref={rootRef} className="relative flex items-center gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-0.5 px-1.5 py-1 text-ink hover:bg-paper-soft"
        >
          {pageSize}
          <svg className="h-4 w-4 text-muted-dark" viewBox="0 0 20 20" fill="currentColor" aria-hidden>
              ...
              return (
                <li key={size} role="option" aria-selected={selected}>
                  <button
                    ...
                    className={`flex w-full justify-center px-3 py-1.5 text-[12px] ${
                      selected ? 'bg-paper-soft text-ink' : 'text-ink hover:bg-paper-soft'
                    }`}
                  >
                    {size}
                  </button>
      ...
      <div className="flex items-center">
        <button
          ...
          className="p-1.5 text-ink hover:bg-paper-soft disabled:cursor-default disabled:text-muted-dark disabled:hover:bg-transparent"
        >
